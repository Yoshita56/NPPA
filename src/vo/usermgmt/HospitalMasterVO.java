...
public class HospitalMasterVO extends ValueObject
{
	...
	private String varUserLicenseAllowed;
	...
	public String getVarUserLicenseAllowed()
	{
		return varUserLicenseAllowed;
	}

	public void setVarUserLicenseAllowed(String varUserLicenseAllowed)
	{
		this.varUserLicenseAllowed = varUserLicenseAllowed;
	}

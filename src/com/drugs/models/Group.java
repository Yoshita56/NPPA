...
public class Group {
	 ...
	 * 
	 * @param strLastModeSeatId
	 *            the new str last mode seat id
	 */
	 ...
	 * 
	 * @param strLastModeDate
	 *            the new str last mode date
	 */
	...
	/**
	 * Gets the strhospital name.
	 * 
	 * @return the strhospital name
	 */
	...
	/**
	 * Sets the strhospital name.
	 * 
	 * @param strhospitalName
	 *            the new strhospital name
	 */
	 ...
	 * 
	 * @param strItemCatCombo
	 *            the new str item cat combo
	 */
	public void setStrItemCatCombo(String strItemCatCombo) {
		this.strItemCatCombo = strItemCatCombo;
	}

	public String getStrHiddenId() {
		return strHiddenId;
	}

	public void setStrHiddenId(String strHiddenId) {
		this.strHiddenId = strHiddenId;
	}
	...
	public String getStrGroupTypeId() {
		return strGroupTypeId;
	}

	public void setStrGroupTypeId(String strGroupTypeId) {
		this.strGroupTypeId = strGroupTypeId;
	}

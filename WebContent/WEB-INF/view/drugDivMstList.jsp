...
<title>Drug Division Master</title>
...
<spring:url value="/division/AddForm"    var="urlAddDrug" />

 

<nav class="navbar navbar-light" style="background-color: #e3f2fd;">
  <a class="navbar-brand">DRUG DIVISION MASTER </a>
  <form class="form-inline">   
     <a class="navbar-brand" href="${urlAddDrug}"><p class="text-primary">ADD DIVISION</p></a>
  </form>
</nav>
    ...
    <div id="content-wrapper">             	  		      
        <!-- DataTables Example -->
           ...
           <div id="drugDivListDiv" style="width:100%;">
	       	<table id='myDatatable' class='display nowrap' width='100%'>
			<thead>
				<tr>
				    <th colspan='1' ></th>
				    <th colspan='1' >Division Name</th>
			...
			<tbody>
				...
				<c:forEach var="tempDrugDiv" items="${drugDivList}">
				<tr>
				    <td></td>
					<td>${tempDrugDiv.strDivisionName}</td>
					<td>${tempDrugDiv.strShortName}</td>			
					<td align="center">
				
						<spring:url value="/division/${tempDrugDiv.strDivisionId}/viewPage"    var="viewUrl" />
											
						<spring:url value="/division/${tempDrugDiv.strDivisionId}/deletePage"  var="deleteUrl" />
						 
						<spring:url value="/division/${tempDrugDiv.strDivisionId}/UpdateForm"  var="updateUrl" />

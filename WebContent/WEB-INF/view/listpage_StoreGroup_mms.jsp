...
<spring:url value="/group/groupAdd"      var="addURL" />

<nav class="navbar navbar-light bg-light">
  <a class="navbar-brand">Group Master</a>
  <form class="form-inline">   
     <a class="navbar-brand" href="${addURL}">ADD GROUP</a>
  </form>
</nav>
    ...
    <div id="content-wrapper">    
        ...
        <!-- DataTables Example -->
           ...
           <div id="indentItemListDiv" style="width:100%;">
	            ...
	            <tbody>
				<c:forEach var="group" items="${groupBean}">
				<input id="strHiddenId" name="strHiddenId" type="hidden" value="${group.strHiddenId}"/>
					<tr>		
					    <td>${group.strHiddenId}</td>			
						<td>${group.strGroupName}</td>
						<td>${group.strEffectiveFrom}</td>					
						 <td>
					
							<spring:url value="/"        var="userUrl" />
	<%-- 						<spring:url value="/${user.id}/delete"  var="deleteUrl" />  --%>
	                       
							<spring:url value="/group/modify/${group.strHiddenId}"  var="modifyURL" />
	                        <spring:url value="/group/delete/${group.strHiddenId}"  var="deleteURL" />
	                        <spring:url value="/group/view/${group.strHiddenId}"    var="viewURL" />	                        

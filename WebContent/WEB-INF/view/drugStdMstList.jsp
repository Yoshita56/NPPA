...
<title>Drug Standard Master</title>
...
<spring:url value="/standard/AddStandardForm"    var="urlAddDrug" />


<nav class="navbar navbar-light" style="background-color: #e3f2fd;">
  <a class="navbar-brand">DRUG STANDARD MASTER </a>
  <form class="form-inline">   
     <a class="navbar-brand" href="${urlAddDrug}"><p class="text-primary">ADD STANDARD</p></a>
  </form>
</nav>
    ...
    <div id="content-wrapper">             	  		      
        <!-- DataTables Example -->
           ...
           <div id="drugStdListDiv" style="width:100%;">
	       	<table id='myDatatable' class='display nowrap' width='100%'>
			<thead>
				<tr>
				    <th colspan='1' ></th>
				    <th colspan='1' >Standard Name</th>
			...
			<tbody>
				...
				<c:forEach var="tempDrugStd" items="${drugStdList}">
				<tr>
				    <td></td>
					<td>${tempDrugStd.strStandardName}</td>
					<td>${tempDrugStd.strShortName}</td>			
					<td align="center">
				
						<spring:url value="/standard/${tempDrugStd.strStandardId}/viewStandardPage"    var="viewUrl" />
											
						<spring:url value="/standard/${tempDrugStd.strStandardId}/deleteStandardPage"  var="deleteUrl" />
						 
						<spring:url value="/standard/${tempDrugStd.strStandardId}/UpdateStandardForm"  var="updateUrl" />

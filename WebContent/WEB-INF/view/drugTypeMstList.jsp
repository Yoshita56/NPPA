...
<spring:url value="/drugType/showFormForAdd"    var="urlAddDrug" />

 
<nav class="navbar navbar-light" style="background-color: #e3f2fd;">
  <a class="navbar-brand">DRUG TYPE MASTER </a>
  <form class="form-inline">   
     <a class="navbar-brand" href="${urlAddDrug}"><p class="text-primary">ADD DRUG TYPE</p></a>
  </form>
</nav>
    ...
    <div id="content-wrapper">             	  		      
        <!-- DataTables Example -->
           ...
           <div id="drugTypeItemListDiv" style="width:100%;">
			...
			<thead>
				<tr>
				    ...
				    <!-- <th colspan='1' ></th> -->
					<!-- <th colspan='1' >ID</th> -->
					<th colspan='1' >Item Type Name</th>
			...
			<tbody>
				...
				<c:forEach var="tempDrug" items="${drugTypeList}">
				<tr>
				    <td></td>
					<!-- <td></td> -->
					<%-- <td>${tempDrug.strItemTypeId}</td> --%>
					<td>${tempDrug.strItemTypeName}</td>
					<td>${tempDrug.strShortName}</td>
					<td>${tempDrug.strEffectiveFrom}</td>					
					<td align="center">
				
						<%-- <spring:url value="/drugType/${tempDrug.strItemTypeId}/view"               var="viewUrl" >
							<spring:param name="strItemTypeId" value="${tempDrug.strItemTypeId}"></spring:param>
						</spring:url> --%>
						
						<spring:url value="/drugType/${tempDrug.strItemTypeId}/view"               var="viewUrl" />
						<spring:url value="/drugType/${tempDrug.strItemTypeId}/delete"             var="deleteUrl" />
						<spring:url value="/drugType/${tempDrug.strItemTypeId}/showFormForUpdate"  var="updateUrl" />

...
function validate1(){
	//alert("hi");
	var strDivisionName=document.getElementById("strDivisionName").value;
	
	if(strDivisionName==""||strDivisionName==null){
		alert("Please Enter Drug Division Name!!");
		return false;
	}
		  ...
		  var retVal=confirm("You Are Going To Save Records!!");
		   if(retVal){
			 var retVal1=confirm("Are You Sure!!");
			  if(retVal1){
			document.drugDivAddForm.action="saveDrugDiv";
			document.drugDivAddForm.method="post";
			document.drugDivAddForm.submit();
			return true;
		  }
	   }
  }  
...
<spring:url value="/division/drugDivList"     var="backToListPage" />
    <div class="container myrow-container">
        <div class="panel panel-success">
             <div class="panel-heading">
                <div class="col-xs-11">
                    <h4>Drug Division>>Add</h4> 
                </div>
            ...
            <div class="panel-body">
             ...
             <form:form cssClass="form-horizontal" name="drugDivAddForm" id="drugDivAddForm" action="saveDrugDiv" modelAttribute="drugDivAdd" onsubmit="return validate1();">                
        	   <form:hidden path="strDivisionId"/>             
                      <div class="form-group">
                        <form:label path="strDivisionName" class="control-label col-xs-2">Drug Division Name</form:label> 
                        <div class="col-xs-10">
                             <form:input cssClass="form-control" path="strDivisionName" id="strDivisionName" placeholder="Enter Division Name"/> 
                        </div>
                    </div>

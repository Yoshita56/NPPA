...
<spring:url value="/group/closeView" var="closeViewURL" />
    <div class="container myrow-container">
        <div class="panel panel-success">
             <div class="panel-heading">
                <div class="col-xs-11">
                    <h4>Drug Group>>View</h4> 
                </div>
            ...
            <div class="panel-body">
				...
				<div class="row">
					...
					<div class="col-sm-10">Drug</div>
				</div>
			
				<div class="row">
					<label class="col-sm-2">Group Name:</label>
					<div class="col-sm-10">${user.strGroupName}</div>
				</div>
			
				<div class="row">
					<label class="col-sm-2">Effective From:</label>
					<div class="col-sm-10">${user.strEffectiveFrom}</div>
				</div>
			
				<div class="row">
					<label class="col-sm-2">Remarks:</label>
					<div class="col-sm-10">${user.strRemarks}</div>
				</div>

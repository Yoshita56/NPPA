...
<head>
    ...
    <title>View Drug Division</title>
...
<spring:url value="/division/drugDivList"     var="urlListPage" />
    <div class="container myrow-container">        
		  ...
		  <div class="panel-body">			    
					 ...
					 <div class="row">                     
                        <label class="col-sm-2">Drug Division Name</label> 
                        <div class="col-sm-10">${drugDivData.strDivisionName}</div>
                     </div>
    
   
                    <div class="row">
                        <label class="col-sm-2">Short Name</label>
                        <div class="col-sm-10">${drugDivData.strShortName}</div>
                    </div>
                  
                    <div class="row">
                        <label class="col-sm-2">Record Status</label>
                        <div class="col-sm-10">${drugDivData.strRecordStatus}</div>
                    </div>

    ...
    <div class="container myrow-container">        
		  ...
		  <div class="panel-body">			    
					 ...
					 <div class="row">                     
                        ...
                        <div class="col-sm-10">${superGroupData.strSuperGrpName}</div>
                     </div>
    
   
                    <div class="row">
                        <label class="col-sm-2">Short Name</label>
                        <div class="col-sm-10">${superGroupData.strSuperGrpShortName}</div>
                    </div>
                  
                    <div class="row">
                        <label class="col-sm-2">Record Status</label>
                        <div class="col-sm-10">${superGroupData.strRecordStatus}</div>
                    </div>

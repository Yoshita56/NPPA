             ...
             <form:form cssClass="form-horizontal" name="drugTypeAddForm" id="drugTypeAddForm" action="saveDrugType" modelAttribute="drugTypeAdd" onsubmit="return validate1();">                
        	   <form:hidden path="strItemTypeId"/>             
                      <div class="form-group">
                        <form:label path="strItemTypeName" class="control-label col-xs-3">Drug Type Name</form:label> 
                        <div class="col-xs-6">
                    ...
                    <div class="form-group">
                        <form:label path="strShortName" cssClass="control-label col-xs-3">Short Name</form:label>
                        <div class="col-xs-6">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-xs-6">
                          	<form:input type="text" path="strEffectiveFrom" class="date-picker"/>    
                        </div>
                    </div>

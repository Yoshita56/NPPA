...
<spring:url value="/drugThearpy/drugThearpyAdd"     var="urlAddDrug" />
 

<nav class="navbar navbar-light" style="background-color: #e3f2fd;">
  <a class="navbar-brand">DRUG THEARPY MASTER </a>
  <form class="form-inline">   
     <a class="navbar-brand" href="${urlAddDrug}"><p class="text-primary">ADD THEARPY</p></a>
  </form>
</nav>
        ...
        <!-- DataTables Example -->
           ...
           <div id="indentItemListDiv" style="width:100%;">
			...
			<thead>
				<tr>
				    <th colspan='1' ></th>
				    <th colspan='1' >Thearpy Name</th>
					<th colspan='1' >Thearpy Short Name</th>
					<th colspan='1' >Action</th>					
				</tr>
			</thead>
			<tbody>
				<!-- Iterating over the list sent from Controller -->
				<c:forEach var="drugThearpyModel" items="${drugThearpyBean}">
				<tr>
				    <td></td>
					
					<td>${drugThearpyModel.thearpyName}</td>
					<td>${drugThearpyModel.thearpyShortName}</td>
								
					<td align="center">
				
						<spring:url value="/drugThearpy/${drugThearpyModel.thearpyId}/view"    var="viewUrl" />						
						<spring:url value="/drugThearpy/${drugThearpyModel.thearpyId}/delete"  var="deleteUrl" /> 
						<spring:url value="/drugThearpy/${drugThearpyModel.thearpyId}/update"  var="updateUrl" />				
